...
export default function About(){
    ...
    return (
        <section id="About"
            className="bg-black text-white pb-24 border-b-15 md:border-b-28 border-ugbb-red-sec"
        >
            <AnimationOnScroll classNameInView={"animate-slide-in-left opacity-100"} classNameNotInView={"opacity-0"}>
                ...
                >
                    <h2 className="font-sans-bartle text-3xl md:text-5xl text-border-red">ABOUT</h2>
                    <h2 className="font-sans-bartle text-3xl md:text-5xl text-border-red">UGBB</h2>
                    <hr className="border-3 w-85 md:w-md rounded-full text-ugbb-red-main mt-2" />
                    <p className="font-dosis text-[15px] md:text-lg md:w-3/8 mt-2 font-bold">
            ...
            <div
                ...
                className="flex flex-col desktop:flex-row justify-center items-center mt-8"
            >
