    ...
    return (
        ...
        >
            ...
            >
                ...
                <div
                    id="TitleContainer"
                    className="flex flex-col justify-center items-center text-ugbb-red-main font-sans-bogle text-9xl"
                >
                    ...
                    <h3 className="text-2xl font-sans-bartle text-border">BE THE BEST - WORK HARD</h3>
                </div>
            </div>
        </section>
    );
